...
local DJ_ICON_TWEEN_INFO = TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In, 1)
...
local function DJButton(props)
	...
	return {
		New "Frame" {
			Position = UDim2.fromScale(0.97, 0.4),
			...
			[Children] = {
				...
				New "ImageButton" {
					...
					Image = Global.UI.DJ_ICON,
					Rotation = Tween(shopIconRotation, DJ_ICON_TWEEN_INFO),
